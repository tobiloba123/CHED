      ...
      <!--------------------------
        ...
        -------------------------->
          ...
          <div style="margin-top: 90px;">
            <h1 style="text-align: center;"> Please Select Report Type </h1>
            <br>
            <br>
          </div>
        <div class="row">
        <div class="col-lg-6 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <a href="withdrawal_report.php" class="small-box-footer">
            <div class="inner">
              <h3>Withdrawals Report</h3>

              <!-- <p>Single Transaction allows you to make contribution for an employee.</p> -->
            </div>
            <div class="icon">
              <i class="ion ion-bag"></i>
            </div>
            Click Here <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-6 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            More info <i class="fa fa-upload"></i></a>
          </div>
        </div>

        <div class="col-lg-6 col-xs-6">
          <!-- small box -->
          <a href="employee_contribution_report.php" class="small-box-footer">
          <div class="small-box bg-green">
            <div class="inner">
