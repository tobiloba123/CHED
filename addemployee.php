               ...
               <!--  <div class="row">
                  <div class="col-md-6"> -->
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" id="exampleInputEmail1" placeholder="Enter Staff ID">
                    </div>
              <!--     </div>
                </div> -->
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Employees Fullname">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="exampleInputEmail1" placeholder="Enter Staff Salary">
                </div>
                <div class="form-group">
