      ...
      <!--------------------------
        ...
        <div class="box">
            <div class="box-header">
              <h3 class="box-title">List of Contribution Types</h3>
              ...
              <div class="pull-right">
                  <a href="addcontributiontype.php" class="btn btn-primary btn-flat"><i class="fa fa-plus"></i> Add Contribution Type</a>
              </div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
