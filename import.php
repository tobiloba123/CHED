      ...
      <!--------------------------
        ...
        -------------------------->
          ...
          <div style="margin-top: 90px;">
            <h1 style="text-align: center;"> Please Select Data Import Type </h1>
            <br>
            <br>
          </div>
        <div class="row">
        <div class="col-lg-6 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <a href="user_import.php" class="small-box-footer">
            <div class="inner">
              <h3>User Data</h3>
        ...
        <div class="col-lg-6 col-xs-6">
          <!-- small box -->
          <a href="contribution_import.php" class="small-box-footer">
