      ...
      <!--------------------------
        ...
        <div class="box">
            <div class="box-header">
              ...
              <div class="pull-right">
                  <a href="#" class="btn btn-success btn-flat"><i class="fa fa-download"></i> Excel File</a>
              </div>

              <!-- <div class="pull-right">
                  <a href="#" class="btn btn-primary btn-flat"><i class="fa fa-plus"></i> Add Employee</a>
              </div>

               <div class="pull-right">
                  <a href="#" class="btn btn-warning btn-flat"><i class="fa fa-upload"></i> Import Employee</a>
              </div> -->
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th>Status</th>
                  <th>Remark</th>
                  <th>Approved / Diasapproved By</th>
                  <th>Credited On</th>
                </tr>
                </thead>
                <tbody>
